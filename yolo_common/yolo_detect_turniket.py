...
from configs import parse_yolo_version
...
def run_example():
    ...
    run_detect_yolo("8ul", model, video_source, output_folder, files=files, conf=0.25,
                    save_txt=True, save_vid=True)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--files', type=str, default=None,
                        help='files names list')  # files from list
