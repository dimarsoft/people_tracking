...
from rtsp.rtsp_tools import print_timed, time_synch, print_exception_time, create_file_name
from yolo_common.yolo8_turniket_online import YOLO8ULTurniketOnline
from yolo_common.yolo_track_main import get_turniket_model_file


class RtspStreamTurniketDetect(object):
    def __init__(self, rtsp_url: str, tag: str, output_folder: Union[str, Path]):
        ...
        self.yolo: Optional[YOLO8ULTurniketOnline] = None
    ...
    def _init_yolo(self):
        ...
        model = get_turniket_model_file(YoloVersion.yolo_v8ul)

        self.yolo = YOLO8ULTurniketOnline(weights_path=model,
                                          save_images_folder=self.output_folder,
                                          fps=self._fps,
